...
public class MinorTriadsPuzzleController : BaseManager
{
    ...
    private void NextButtonCallback(GameObject g)
    {
        ...
        {
            Persistent.sceneToLoad = "MajorSeventhChords";
    ...
    private void LevelComplete()
    {
        ...
        {            
            ...
            if (stars > Persistent.harmonyLessons.scores["Minor Triads"])
            {
                Persistent.harmonyLessons.scores["Minor Triads"] = stars;
                Persistent.harmonyLessons.lessons["Major Seventh Chords"] = true;
